...
public interface SubcategoryRepo extends JpaRepository<Subcategory, Integer>{
	...
	@Query("select new com.qci.ecommercewebapp.JoinEntity.CategorySubcategoryJoin (b.id, b.subcategory, a.title ,b.created_date, b.updated_date, b.status)from Subcategory b inner join Category a on b.category = a.id")
